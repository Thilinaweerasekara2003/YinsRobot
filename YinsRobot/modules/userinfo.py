...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        disaster_level_present = True
    elif user.id == 1377217980:
         text += "\n\nOwner Of A Bot. Queen Of @DarkRider2003. Bot Name Inspired From 'JoJo'."
         disaster_level_present = True
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/HiTechRockets"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/HiTechRockets")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
